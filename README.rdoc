...
* Simple example of an hash containing error information. If one is just interested in the :error_code and the :error_message but doesn't know the depth, this is a good way of extracting that information:
